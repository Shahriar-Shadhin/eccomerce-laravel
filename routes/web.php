...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['isAdmin'])->prefix('admin')->group(function() {
        ...
        Route::get('customers/{id}/edit', [App\Http\Controllers\Backend\CustomerController::class, 'edit'])->name('admin.customer.edit');
        Route::post('customers/{id}/edit', [App\Http\Controllers\Backend\CustomerController::class, 'update']);
        Route::get('customers/{id}/delete', [App\Http\Controllers\Backend\CustomerController::class, 'delete'])->name('admin.customer.delete');
